...
# --- DIESE ROUTE WAR DER FEHLER ---
# Sie muss @admin_bp heißen, nicht @main_bp!
@admin_bp.route('/users')
@login_required
def users_manager():
    # Diese Route ist eigentlich redundant, wenn wir /users in main.py nutzen.
    # Wir leiten einfach auf die Haupt-Liste um, um Verwirrung zu vermeiden.
